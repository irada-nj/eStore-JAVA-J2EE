...
public class AddProduit extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String filename=p1.getHeader("content-disposition");
            ...
            Produit p=new Produit(0,cat,libelle,marque,prix,description,frais, disponible,qte,new Date(),null,null,images,null,null);;
            ...
            request.setAttribute("msg", "The product has been successfully added");
