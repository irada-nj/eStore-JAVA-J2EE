    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       long nocarte=Long.parseLong(request.getParameter("nocarte"));
        ...
        if(PaiementWS.payerCommande(nocarte, datecarte, crypto, mnt).startsWith("Ok")){
           ...
           Commande cmd=new Commande(0, clt, null,new Date(), "VISA", "en cours",null, new ArrayList<Lignecommande>());
           ...
           request.setAttribute("msg", "your order is successfully paid and will be shipped soon!");
           request.getRequestDispatcher("/views/mescommandes.jsp").forward(request, response);
           
        }else{
            request.setAttribute("msg", "incorrect payment information!!");
