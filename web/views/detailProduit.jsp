<%-- 
    ...
    Created on : 17 mars 2022, 08:27:58
    Author     : IRADA
--%>
					...
					<%--		<div id="similar-product" class="carousel slide" data-ride="carousel">
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								...
								<img src="eStore/images/product-details/rating.png" alt="" />
								<span>
								...
								<p><b>Availability:</b> <%=p.getDisponibilite()?"Available":"Unavailable"%></p>
								<p><b>Condition:</b> New</p>
								<p><b>Brand:</b> <%=p.getMarque()%></p>
								<a href=""><img src="eStore/images/product-details/share.png" class="share img-responsive"  alt="" /></a>
							...
							<div class="tab-pane fade active in" id="reviews" >
								<div class="col-sm-12">
									...
									<form action="#">
										...
										<b>Rating: </b> <img src="eStore/images/product-details/rating.png" alt="" />
