<%-- 
    Document   : panier
    Created on : 17 mars 2022, 14:23:38
    Author     : IRADA
--%>
...
<jsp:include page="header.jsp"></jsp:include>
	...
	<section id="do_action">
      ...
      <%-- le sous total du panier --%>                 <li>Cart Sub Total<span>$<%=panier.total()%></span></li>
							<li>Shipping Cost <span><%=panier.fraisexpedition()%></span></li>
